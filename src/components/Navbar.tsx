          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2 px-4 pt-2">
                ...
                <Button
                  onClick={() => {
                    onNavigate('login', 'signup'); // 👈 Signup
                    setIsMobileMenuOpen(false);
                  }}
                  className="w-full bg-gradient-to-r from-[#FFB200] to-[#FF4D67] text-white border-0"
                >
                  Get Started
                </Button>
              </div>
