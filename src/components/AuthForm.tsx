...
export function AuthForm({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#FFF8F8] via-white to-[#FFF8F8] px-4">
      {/* ✅ LOGIN FORM */}
      {view === "login" && (
        <Card>
          ...
          <button
            type="button"
            className="w-full bg-gradient-to-r from-[#FFB200] via-[#FF4D67] to-[#176B87] text-white font-semibold py-3 rounded-full shadow-md hover:opacity-90 transition mb-2"
          >
            Sign In
          </button>
          ...
          <button className="mb-2 w-full flex items-center justify-center gap-2 border border-gray-300 rounded-full py-3 hover:bg-gray-50 transition text-gray-700 font-medium">
            <img
      ...
      {view === "signup" && (
        <Card>
          ...
          <button
            type="button"
            className="w-full bg-gradient-to-r from-[#FFB200] via-[#FF4D67] to-[#176B87] text-white font-semibold py-3 rounded-full shadow-md hover:opacity-90 transition mb-3"
          >
            Sign Up
          </button>
          ...
          <p className="text-[13px] text-gray-600 leading-snug mb-4">
            ...
            <span className="text-[#FF4D67] hover:underline cursor-pointer">
              Terms & Conditions
            </span>{" "}
            and{" "}
            <span className="text-[#FF4D67] hover:underline cursor-pointer">
      ...
      {view === "forgot" && (
        <Card>
          <div className="flex items-center gap-2 mb-6">
            <button
              onClick={() => setView("login")}
              className="p-2 text-gray-500 hover:text-[#FF4D67] transition"
            >
